...
@section('content')
    <div class="main-slider lg:grid lg:grid-cols-3 items-end">
        <div class="lg:col-span-2">
            <img src="/images/categories/{{ $category->category_image_detail }}" alt="" srcset="">
        </div>
    ...
    <div class="max-w-screen-xl 2xl:max-w-screen-2xl mx-auto">
        ...
        <div id="section-product" class="grid lg:grid-cols-3 grid-cols-2 lg:py-24 py-12 lg:px-8 px-4">
            ...
            <a href="{{url("product",["product"=>$item->product_slug])}}" class="product-item block -my-px p-4 border border-gray-300">
                <div class="product-img py-8 relative">
                    ...
                    <button class="btn-add-cart absolute right-2 top-2">
                        <img src="/front/images/shopping-bag.png" width="24px" alt="" srcset="">
                    </button>
                </div>
        ...
        <!-- Mô tả nhóm sản phẩm -->
        <div id="section-product-desc " class="py-8 border-t border-b border-gray-300 lg:px-8 px-4">
            <h3 class="uppercase text-medium mb-4">{{ $category->topic1 }}</h3>
            <p class="mb-6">
                {{ $category->description_topic1 }}
            </p>
            <h3 class="uppercase text-medium mb-4">{{ $category->topic2 }}</h3>
            <p class="mb-6">
                {{ $category->description_topic2 }}
            </p>
        </div>
        <!-- Liên hệ -->
