    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-dark">Edit Project Category</h4>
                    </div>
                ...
                <hr>
                <form action="{{ route('admin.manage-project-categories.update-project-category') }}" method="POST"
                      enctype="multipart/form-data" class="mt-3">
                    <input type="hidden" name="project_category_id" value="{{ Request('id') }}">
                    @csrf
                        ...
                        <div class="col-md-12 row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="project_category_name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="project_category_description">{{$project_category->project_category_description}}</textarea>
                        ...
                        <div class="col-md-12 row">
                            <div class="col-md-6">
                                ...
                                <div class="avatar mb-3">
                                    <img src="/images/project-categories/{{ $project_category->project_category_image }}" alt="" width="200" height="200" id="project_category_image_preview">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="avatar mb-3">
                                    <img src="/images/project-categories/{{ $project_category->project_category_thumbnail }}" alt="" width="400" height="400" id="project_category_thumbnail_preview">
                                </div>
                            </div>
                        </div>
                    </div>
